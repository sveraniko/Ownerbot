...
* **DSC_STATUS** — Сводка активных скидок/купонов
* **DSC_TOP_USED** — Топ используемых купонов

### Создание/изменение (если поддерживается SIS)

* **DSC_CREATE_COUPON** — Создать купон
* **DSC_DISABLE_COUPON** — Отключить купон
* **DSC_BULK_DISABLE** — Отключить пачку купонов по правилу
