...
from app.retro.service import retro_summary
...
async def handle(payload: Payload, correlation_id: str, session) -> ToolResponse:
    ...
    summary = await retro_summary(session, payload.period_days)
    ...
    return ToolResponse.ok(
        ...
        data={"period_days": payload.period_days, "summary": summary.to_dict(), "text": text},
