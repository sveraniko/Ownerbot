...
from app.retro.service import retro_gaps
...
async def handle(payload: Payload, correlation_id: str, session) -> ToolResponse:
    ...
    gaps = await retro_gaps(session, payload.period_days)
    ...
    return ToolResponse.ok(
        ...
        data={"period_days": payload.period_days, "gaps": gaps.to_dict(), "text": text},
