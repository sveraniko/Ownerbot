...
class OwnerNotifySettings(Base):
    ...
    ops_alerts_cooldown_hours: Mapped[int] = mapped_column(Integer, nullable=False, default=6)
    ops_alerts_last_seen_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
    ops_alerts_last_sent_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ops_alerts_last_error_notice_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ops_unanswered_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    ops_unanswered_threshold_hours: Mapped[int] = mapped_column(Integer, nullable=False, default=2)
    ops_unanswered_min_count: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    ops_stuck_orders_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    ops_stuck_orders_min_count: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    ops_stuck_orders_preset: Mapped[str] = mapped_column(String(32), nullable=False, default="stuck")
    ops_payment_issues_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    ops_payment_issues_min_count: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    ops_payment_issues_preset: Mapped[str] = mapped_column(String(32), nullable=False, default="payment_issues")
    ops_errors_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    ops_errors_window_hours: Mapped[int] = mapped_column(Integer, nullable=False, default=24)
    ops_errors_min_count: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    ops_out_of_stock_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    ops_out_of_stock_min_count: Mapped[int] = mapped_column(Integer, nullable=False, default=1)
    ops_low_stock_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    ops_low_stock_lte: Mapped[int] = mapped_column(Integer, nullable=False, default=5)
    ops_low_stock_min_count: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    escalation_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=False)
    escalation_stage1_after_minutes: Mapped[int] = mapped_column(Integer, nullable=False, default=120)
    escalation_repeat_every_minutes: Mapped[int] = mapped_column(Integer, nullable=False, default=360)
    escalation_max_repeats: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    escalation_snoozed_until: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    escalation_on_fx_failed: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    escalation_on_out_of_stock: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    escalation_on_stuck_orders_severe: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    escalation_on_errors_spike: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    escalation_on_unanswered_chats_severe: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=False)
    escalation_stuck_orders_min: Mapped[int] = mapped_column(Integer, nullable=False, default=3)
    escalation_errors_min: Mapped[int] = mapped_column(Integer, nullable=False, default=5)
    escalation_unanswered_chats_min: Mapped[int] = mapped_column(Integer, nullable=False, default=5)
    escalation_unanswered_threshold_hours: Mapped[int] = mapped_column(Integer, nullable=False, default=6)
    escalation_last_event_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
    escalation_first_seen_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    escalation_last_sent_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    escalation_repeat_count: Mapped[int] = mapped_column(Integer, nullable=False, default=0)
    escalation_last_ack_key: Mapped[str | None] = mapped_column(String(255), nullable=True)
    escalation_last_ack_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    ...
    digest_quiet_enabled: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=False)
    digest_quiet_attempt_interval_minutes: Mapped[int] = mapped_column(Integer, nullable=False, default=60)
    digest_quiet_max_silence_days: Mapped[int] = mapped_column(Integer, nullable=False, default=7)
    digest_quiet_min_revenue_drop_pct: Mapped[float] = mapped_column(Numeric(6, 2), nullable=False, default=8.0)
    digest_quiet_min_orders_drop_pct: Mapped[float] = mapped_column(Numeric(6, 2), nullable=False, default=10.0)
    digest_quiet_send_on_ops: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    digest_quiet_send_on_fx_failed: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    digest_quiet_send_on_errors: Mapped[bool] = mapped_column(Boolean(), nullable=False, default=True)
    digest_last_attempt_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
    digest_last_skipped_at: Mapped[datetime | None] = mapped_column(DateTime(timezone=True), nullable=True)
